...
pred_sex = prediction_counter(params_df = model_sex$params, 
                              ...
                              ymin_age_weight = -1,
                              ymax_age_weight = 1,
                              plot_text = "Intervention bei Geschlecht", 
...
pred_race_wb = prediction_counter(params_df = model_race_wb$params, 
                                  ...
                                  color_nr = 1, 
                                  seed = 49586783,
                                  plot_text = "Intervention bei Race: Weiß \u2194 Schwarz", 
...
pred_race_wh = prediction_counter(params_df = model_race_wh$params, 
                                  ...
                                  color_nr = 4, 
                                  seed = 28975065,
                                  plot_text = "Intervention bei Race: Weiß \u2194 Hispanisch", 
...
pred_race_wo = prediction_counter(params_df = model_race_wo$params, 
                                  ...
                                  color_nr = 5, 
                                  seed = 455927483,
                                  plot_text = "Intervention bei Race: Weiß \u2194 Andere", 
...
plot_weights_sex = rbind(weights_sex_base, weights_sex_counter) %>% 
  ...
  facet_wrap(~ Modell, dir = "v") +
  labs(y =  "Median \u00b1 MAD") +
  guides(color = "none") +
  scale_color_manual(values = wes_palette("Zissou1")[2:3]) +
  coord_flip()
...
plot_weights_race = rbind(weights_race_base, 
  ...
  facet_wrap(~ Modell, nrow = 4, ncol = 1) +
  labs(y =  "Median \u00b1 MAD") +
  guides(color = "none") +
  scale_color_manual(values = wes_palette("Zissou1")[2:5]) +
  coord_flip()

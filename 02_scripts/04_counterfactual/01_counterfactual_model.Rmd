...
model_base = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                 "03_model_base.rds")
                    )

pred_base = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                "04_pred_base.rds")
                   )
```
...
model_sexm = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                 "05_model_sexm.rds")
                    )

pred_sexm = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                "06_pred_sexm.rds")
                   )
```
...
sex_comp_logit = pred_sexf$plot_comp_logit +
                    ...
                    geom_label(x = 0.88, y = 1.25, label = "Female", color = bin_colors[3,1]) 
...
model_sexf = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                 "07_model_sexf.rds")
                    )

pred_sexf = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                "08_pred_sexf.rds")
                   )
```
...
model_racewhite = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                 "09_model_racewhite.rds")
                    )

pred_racewhite = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                "10_pred_racewhite.rds")
                   )
```
...
model_raceblack = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                 "11_model_raceblack.rds")
                    )

pred_raceblack = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                "12_pred_raceblack.rds")
                   )
```
...
model_raceasian = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                 "13_model_raceasian.rds")
                    )

pred_raceasian = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                "14_raceasian.rds")
                   )
```
...
model_racehisp = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                 "15_model_racehisp.rds")
                    )

pred_racehisp = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                "16_racehisp.rds")
                   )
```
...
model_racenative = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                 "17_model_racenative.rds")
                    )

pred_racenative = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                "18_racenative.rds")
                   )
```
...
model_raceother = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                 "19_model_raceother.rds")
                    )

pred_raceother = readRDS(file = here("01_data", "02_data_processed", "04_counterfactual", "big_data",
                                "20_raceother.rds")
                   )
```
